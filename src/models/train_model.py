...
def get_model_instance(name, params):
    ...
    # Now, instantiate the class with the provided parameters
...
def main(args):
    ...
    with mlflow.start_run(run_name="final_training"):
        ...
        f1 = float(f1_score(y_test, y_pred, average='weighted')) # Use weighted for multi-class
        ...
        logger.info(f"Final f1: {f1:.2f}, Accuracy: {accuracy:.4f}")
